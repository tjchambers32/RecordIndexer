...
package main.java.client.communication;
...
public class ClientCommunicator {
	 ...
	 *         can't connect to the main.java.server, internal main.java.server error).
	 ...
	 *         main.java.server, internal main.java.server error).
	 * @throws ClientException 
	 * 
	 */
	 ...
	 *         cant connect to the main.java.server, internal main.java.server error,etc.) returns
	 *         FAILED
	 * @throws ClientException 
	 * 
	 */
	 ...
	 *         number of values, cant connect to the main.java.server, internal main.java.server
